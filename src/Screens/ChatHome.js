...
function UsersComponent(props) {
    ...
    return (
        ...
        >
            ...
            {props.users.length == 0 ? <Button onClick={handleDrawer}>Add USer</Button> : ''}
        </List>
    );
}
    ...
    return (
        <div style={root}>
            ...
            <Paper style={right}>
                ...
                <div style={{ width: "100%", display: "flex", flex: 0.08, boxShadow: "0px 0px 10px rgba(1, 0, 0, 0.1)" }}>
                    <input
                        value={chatMessage}
